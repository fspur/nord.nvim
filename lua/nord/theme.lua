...
theme.loadLSP = function()
	...
	local lsp = {
		...
		LspDiagnosticsVirtualTextError = { fg = nord.nord11_gui , bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Error"
		...
		LspDiagnosticsVirtualTextWarning = { fg = nord.nord15_gui bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Warning"
