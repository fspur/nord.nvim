...
theme.loadLSP = function()
	...
	local lsp = {
		...
		LspDiagnosticsVirtualTextError = { fg = "#d65e6a", bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Error"
		...
		LspDiagnosticsVirtualTextWarning = { fg = "#948362", bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Warning"
		...
		LspDiagnosticsVirtualTextInformation = { fg = nord.nord10_gui, bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Information"
		...
		LspDiagnosticsVirtualTextHint = { fg = nord.nord9_gui, bg = nord.nord2_gui, style = "italic" }, -- Virtual text "Hint"
